# caspers_kitchen_analytics

The 'caspers_kitchen_analytics' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] caspers_kitchen_analytics_etl` to your workspace.
